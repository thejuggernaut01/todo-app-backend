export const verifyEmailTemplate = (token: string, name: string) => {
  return `
          <main>
            ...
            <p>To complete your registration and start using our app, please verify your email address by clicking the button below:</p>

            <button>
              <a href="http://localhost:3000/verify-email?token=${token}">Verify Account</a>
            </button>
